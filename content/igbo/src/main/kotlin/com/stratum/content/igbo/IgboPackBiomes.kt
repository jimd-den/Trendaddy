...
internal object IgboPackBiomes {
    ...
    val sacredGrove = BiomeDefinition(
        ...
        roughness = 0.7f,
        scatter = listOf(
            ScatterRule(IgboPackBlocks.irokoTrunk.id, chance = 0.055f, height = 4, capBlockId = IgboPackBlocks.irokoCanopy.id),
    ...
    val mistMarsh = BiomeDefinition(
        ...
        scatter = listOf(
            ScatterRule(IgboPackBlocks.palmReed.id, chance = 0.05f, height = 1),
            ScatterRule(IgboPackBlocks.irokoTrunk.id, chance = 0.02f, height = 3, capBlockId = IgboPackBlocks.irokoCanopy.id),
        ),
